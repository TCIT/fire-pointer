...
class PointsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create point" do
    assert_difference('Point.count') do
      post points_url, params: { point: { description: @point.description, lat: @point.lat, lng: @point.lng } }
    end
  ...
  test "should update point" do
    patch point_url(@point), params: { point: { description: @point.description, lat: @point.lat, lng: @point.lng } }
